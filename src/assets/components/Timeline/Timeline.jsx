  ...
  const timelineElements = [
    {
      ...
      location: "SICORP SRL",
      description: "Participación activa en el desarrollo de aplicaciones web como parte del equipo de tecnología. Diseño e implementación de interfaces responsivas, priorizando la experiencia del usuario y la escalabilidad del código.",
      date: "Abril 2025 - Presente",
      tech: ["ReactJs", "Tailwind CSS", "TypeScript", "NestJS", "MySQL"],
      icon: "work",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      location: "UTN",
      description: "Actualmente en el primer año de la carrera de Ingeniería en Sistemas en UTN, donde estoy adquiriendo conocimientos básicos de matemáticas, física y fundamentos de la programación. La formación inicial se enfoca en desarrollar una comprensión sólida de los principios teóricos que servirán de base para proyectos más avanzados en el futuro.",
